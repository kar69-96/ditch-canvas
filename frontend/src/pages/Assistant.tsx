  ...
  const features = [
    {
      ...
      description: "Stay informed with timely notifications about your assignments and coursework.",
      date: "Stay connected",
    },
    {
      icon: Mail,
      title: "TA Communication",
      description: "Automate your communication with teaching assistants and manage your academic correspondence.",
      date: "Save time",
    },
    {
      icon: BookOpen,
      title: "Personalized Studying",
      description: "Get customized study schedules tailored to your courses and learning preferences.",
      date: "Study smarter",
    },
  ];
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4 max-w-2xl mx-auto">
              <h2 className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Tabus texts you directly to make sure you stay on track with your goals. Emails TAs, gives you personalized study plans, and so much more.
              </h2>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground font-medium mt-auto">{feature.date}</p>
                  </div>
                );
              })}
            </div>
            ...
            <div className="space-y-4 pt-4">
              <p className="text-2xl md:text-3xl font-semibold">Join for $10/month</p>
              <button
