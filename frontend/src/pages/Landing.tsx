...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="absolute top-[15vh] left-1/2 transform -translate-x-1/2 relative z-10 text-center">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4">
          Focus on <span className="italic bg-[hsl(40,30%,96%)] px-2">Learning</span>
        </h1>
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold">
          Not on <span className="italic">Canvas</span>
          {/* <span className="italic bg-[hsl(40,30%,96%)] text-black px-2">Canvas</span> */}
        </h1>
      </div>
