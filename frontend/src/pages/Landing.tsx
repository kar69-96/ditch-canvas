  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="absolute top-[15vh] left-1/2 transform -translate-x-1/2 relative z-10 text-center px-4">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-center sm:items-baseline gap-2 sm:gap-0 mb-3 sm:mb-4">
          <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
            Focus on
          </h1>
          <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-bold italic bg-[hsl(40,30%,96%)] px-2 sm:ml-3">
            Learning
          </h1>
        </div>
        <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl font-bold">
