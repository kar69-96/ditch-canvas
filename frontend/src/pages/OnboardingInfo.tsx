  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.validSchool && result.data) {
        // Valid school - store data and proceed to next step
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={school} onValueChange={setSchool} disabled={loading}>
                ...
                <SelectContent>
                  <SelectItem value="Brown University">Brown University</SelectItem>
                  <SelectItem value="California State University">California State University</SelectItem>
                  ...
                  <SelectItem value="Dartmouth College">Dartmouth College</SelectItem>
                  <SelectItem value="Harvard University">Harvard University</SelectItem>
                  <SelectItem value="Pennsylvania State University">Pennsylvania State University</SelectItem>
                  ...
                  <SelectItem value="University of California, Berkeley">University of California, Berkeley</SelectItem>
                  <SelectItem value="University of California, Los Angeles">University of California, Los Angeles</SelectItem>
                  <SelectItem value="University of Colorado - Boulder">University of Colorado - Boulder</SelectItem>
                  <SelectItem value="University of Colorado - Denver">University of Colorado - Denver</SelectItem>
